    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 27, 1, 743);
    			...
    			add_location(div0, file$3, 30, 3, 838);
    			attr_dev(div1, "class", "img svelte-18h6rv8");
    			add_location(div1, file$3, 29, 2, 817);
    			attr_dev(h20, "class", "row__title svelte-18h6rv8");
    			add_location(h20, file$3, 34, 4, 1050);
    			attr_dev(div2, "class", "row svelte-18h6rv8");
    			add_location(div2, file$3, 33, 3, 1028);
    			attr_dev(h21, "class", "row__title svelte-18h6rv8");
    			add_location(h21, file$3, 38, 4, 1186);
    			attr_dev(div3, "class", "row svelte-18h6rv8");
    			add_location(div3, file$3, 37, 3, 1164);
    			attr_dev(h22, "class", "row__title svelte-18h6rv8");
    			add_location(h22, file$3, 42, 4, 1317);
    			attr_dev(div4, "class", "row svelte-18h6rv8");
    			add_location(div4, file$3, 41, 3, 1295);
    			attr_dev(h23, "class", "row__title svelte-18h6rv8");
    			add_location(h23, file$3, 46, 4, 1435);
    			add_location(button, file$3, 47, 4, 1475);
    			attr_dev(div5, "class", "row svelte-18h6rv8");
    			add_location(div5, file$3, 45, 3, 1413);
    			attr_dev(div6, "class", "dashbord");
    			add_location(div6, file$3, 32, 2, 1002);
    			attr_dev(div7, "class", "wrap svelte-18h6rv8");
    			add_location(div7, file$3, 28, 1, 796);
    			add_location(main, file$3, 26, 0, 666);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
