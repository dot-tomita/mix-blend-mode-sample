    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 27, 1, 747);
    			...
    			add_location(div0, file$3, 30, 3, 842);
    			attr_dev(div1, "class", "img svelte-1kqho3i");
    			add_location(div1, file$3, 29, 2, 821);
    			attr_dev(h20, "class", "row__title svelte-1kqho3i");
    			add_location(h20, file$3, 34, 4, 1054);
    			attr_dev(div2, "class", "row svelte-1kqho3i");
    			add_location(div2, file$3, 33, 3, 1032);
    			attr_dev(h21, "class", "row__title svelte-1kqho3i");
    			add_location(h21, file$3, 38, 4, 1190);
    			attr_dev(div3, "class", "row svelte-1kqho3i");
    			add_location(div3, file$3, 37, 3, 1168);
    			attr_dev(h22, "class", "row__title svelte-1kqho3i");
    			add_location(h22, file$3, 42, 4, 1321);
    			attr_dev(div4, "class", "row svelte-1kqho3i");
    			add_location(div4, file$3, 41, 3, 1299);
    			attr_dev(h23, "class", "row__title svelte-1kqho3i");
    			add_location(h23, file$3, 46, 4, 1439);
    			add_location(button, file$3, 47, 4, 1479);
    			attr_dev(div5, "class", "row svelte-1kqho3i");
    			add_location(div5, file$3, 45, 3, 1417);
    			attr_dev(div6, "class", "dashbord");
    			add_location(div6, file$3, 32, 2, 1006);
    			attr_dev(div7, "class", "wrap svelte-1kqho3i");
    			add_location(div7, file$3, 28, 1, 800);
    			add_location(main, file$3, 26, 0, 670);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "title");
    			add_location(h1, file$1, 47, 1, 1241);
    			...
    			add_location(div0, file$1, 50, 3, 1329);
    			attr_dev(div1, "class", "img svelte-12c1qho");
    			add_location(div1, file$1, 49, 2, 1308);
    			attr_dev(h20, "class", "row__title svelte-12c1qho");
    			add_location(h20, file$1, 57, 4, 1675);
    			attr_dev(div2, "class", "row svelte-12c1qho");
    			add_location(div2, file$1, 56, 3, 1653);
    			attr_dev(h21, "class", "row__title svelte-12c1qho");
    			add_location(h21, file$1, 61, 4, 1811);
    			attr_dev(div3, "class", "row svelte-12c1qho");
    			add_location(div3, file$1, 60, 3, 1789);
    			attr_dev(h22, "class", "row__title svelte-12c1qho");
    			add_location(h22, file$1, 65, 4, 1954);
    			attr_dev(div4, "class", "row svelte-12c1qho");
    			add_location(div4, file$1, 64, 3, 1932);
    			add_location(h23, file$1, 69, 4, 2091);
    			attr_dev(div5, "class", "row svelte-12c1qho");
    			add_location(div5, file$1, 68, 3, 2069);
    			attr_dev(h24, "class", "row__title svelte-12c1qho");
    			add_location(h24, file$1, 73, 4, 2202);
    			attr_dev(div6, "class", "row svelte-12c1qho");
    			add_location(div6, file$1, 72, 3, 2180);
    			attr_dev(h25, "class", "row__title svelte-12c1qho");
    			add_location(h25, file$1, 77, 4, 2335);
    			attr_dev(div7, "class", "row svelte-12c1qho");
    			add_location(div7, file$1, 76, 3, 2313);
    			attr_dev(h26, "class", "row__title svelte-12c1qho");
    			add_location(h26, file$1, 81, 4, 2453);
    			add_location(button0, file$1, 82, 4, 2495);
    			attr_dev(div8, "class", "row svelte-12c1qho");
    			add_location(div8, file$1, 80, 3, 2431);
    			attr_dev(h27, "class", "row__title svelte-12c1qho");
    			add_location(h27, file$1, 85, 4, 2583);
    			add_location(button1, file$1, 86, 4, 2627);
    			attr_dev(div9, "class", "row svelte-12c1qho");
    			add_location(div9, file$1, 84, 3, 2561);
    			attr_dev(div10, "class", "dashbord");
    			add_location(div10, file$1, 55, 2, 1627);
    			attr_dev(div11, "class", "wrap svelte-12c1qho");
    			add_location(div11, file$1, 48, 1, 1287);
    			add_location(main, file$1, 46, 0, 1164);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
