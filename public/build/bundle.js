...
var app = (function () {
    ...
    const file$7 = "src/component/SelectMixmode.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option0, file$7, 13, 2, 278);
    			option1.__value = "darken";
    			option1.value = option1.__value;
    			add_location(option1, file$7, 14, 2, 323);
    			option2.__value = "multiply";
    			option2.value = option2.__value;
    			add_location(option2, file$7, 15, 2, 371);
    			option3.__value = "color-burn";
    			option3.value = option3.__value;
    			add_location(option3, file$7, 16, 2, 420);
    			option4.__value = "lighten";
    			option4.value = option4.__value;
    			add_location(option4, file$7, 17, 2, 475);
    			option5.__value = "screen";
    			option5.value = option5.__value;
    			add_location(option5, file$7, 18, 2, 525);
    			option6.__value = "color-dodge";
    			option6.value = option6.__value;
    			add_location(option6, file$7, 19, 2, 573);
    			option7.__value = "overlay";
    			option7.value = option7.__value;
    			add_location(option7, file$7, 20, 2, 630);
    			option8.__value = "soft-light";
    			option8.value = option8.__value;
    			add_location(option8, file$7, 21, 2, 681);
    			option9.__value = "hard-light";
    			option9.value = option9.__value;
    			add_location(option9, file$7, 22, 2, 738);
    			option10.__value = "difference";
    			option10.value = option10.__value;
    			add_location(option10, file$7, 23, 2, 795);
    			option11.__value = "exclusion";
    			option11.value = option11.__value;
    			add_location(option11, file$7, 24, 2, 851);
    			option12.__value = "hue";
    			option12.value = option12.__value;
    			add_location(option12, file$7, 25, 2, 902);
    			option13.__value = "saturation";
    			option13.value = option13.__value;
    			add_location(option13, file$7, 26, 2, 941);
    			option14.__value = "color";
    			option14.value = option14.__value;
    			add_location(option14, file$7, 27, 2, 994);
    			option15.__value = "luminosity";
    			option15.value = option15.__value;
    			add_location(option15, file$7, 28, 2, 1038);
    			attr_dev(select, "class", "svelte-1osu7gw");
    			if (/*value*/ ctx[0] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[2].call(select));
    			add_location(select, file$7, 12, 0, 221);
    		},
    		l: function claim(nodes) {
    ...
    const file$6 = "src/component/InputColor.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$6, 13, 2, 244);
    			attr_dev(label, "for", "bgcolor");
    			attr_dev(label, "class", "svelte-q1ocbv");
    			add_location(label, file$6, 12, 0, 220);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$5 = "src/component/FileReader.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$5, 20, 2, 456);
    			attr_dev(label, "for", "bgcolor");
    			attr_dev(label, "class", "svelte-1n6p6dj");
    			add_location(label, file$5, 19, 0, 432);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src/pages/BgBlendMode.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 27, 1, 743);
    			attr_dev(div0, "class", div0_class_value = "bg " + (/*animate*/ ctx[0] ? 'fadein' : 'hide') + " svelte-18h6rv8");
    			...
    			add_location(div0, file$4, 30, 3, 838);
    			attr_dev(div1, "class", "img svelte-18h6rv8");
    			add_location(div1, file$4, 29, 2, 817);
    			attr_dev(h20, "class", "row__title svelte-18h6rv8");
    			add_location(h20, file$4, 34, 4, 1050);
    			attr_dev(div2, "class", "row svelte-18h6rv8");
    			add_location(div2, file$4, 33, 3, 1028);
    			attr_dev(h21, "class", "row__title svelte-18h6rv8");
    			add_location(h21, file$4, 38, 4, 1186);
    			attr_dev(div3, "class", "row svelte-18h6rv8");
    			add_location(div3, file$4, 37, 3, 1164);
    			attr_dev(h22, "class", "row__title svelte-18h6rv8");
    			add_location(h22, file$4, 42, 4, 1317);
    			attr_dev(div4, "class", "row svelte-18h6rv8");
    			add_location(div4, file$4, 41, 3, 1295);
    			attr_dev(h23, "class", "row__title svelte-18h6rv8");
    			add_location(h23, file$4, 46, 4, 1435);
    			add_location(button, file$4, 47, 4, 1475);
    			attr_dev(div5, "class", "row svelte-18h6rv8");
    			add_location(div5, file$4, 45, 3, 1413);
    			attr_dev(div6, "class", "dashbord");
    			add_location(div6, file$4, 32, 2, 1002);
    			attr_dev(div7, "class", "wrap svelte-18h6rv8");
    			add_location(div7, file$4, 28, 1, 796);
    			add_location(main, file$4, 26, 0, 666);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*animate*/ 1 && div0_class_value !== (div0_class_value = "bg " + (/*animate*/ ctx[0] ? 'fadein' : 'hide') + " svelte-18h6rv8")) {
    ...
    const file$3 = "src/component/InputTxt.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-q1ocbv");
    			add_location(input, file$3, 13, 2, 241);
    			attr_dev(label, "for", "text");
    			attr_dev(label, "class", "svelte-q1ocbv");
    			add_location(label, file$3, 12, 0, 220);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "src/pages/MixBlendMode.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "title");
    			add_location(h1, file$2, 51, 1, 1346);
    			attr_dev(span, "class", span_class_value = "overtxt " + (/*animateTxt*/ ctx[1] ? 'fadein' : 'hide') + " svelte-1p52rxf");
    			...
    			add_location(span, file$2, 55, 4, 1526);
    			...
    			attr_dev(img, "class", "svelte-1p52rxf");
    			add_location(img, file$2, 56, 4, 1685);
    			attr_dev(div0, "class", div0_class_value = "inner " + (/*animate*/ ctx[0] ? 'fadein' : 'hide') + " svelte-1p52rxf");
    			set_style(div0, "background-color", /*bgcolor*/ ctx[4]);
    			add_location(div0, file$2, 54, 3, 1434);
    			attr_dev(div1, "class", "img svelte-1p52rxf");
    			add_location(div1, file$2, 53, 2, 1413);
    			attr_dev(h20, "class", "row__title svelte-1p52rxf");
    			add_location(h20, file$2, 61, 4, 1818);
    			attr_dev(div2, "class", "row svelte-1p52rxf");
    			add_location(div2, file$2, 60, 3, 1796);
    			attr_dev(h21, "class", "row__title svelte-1p52rxf");
    			add_location(h21, file$2, 65, 4, 1958);
    			attr_dev(div3, "class", "row svelte-1p52rxf");
    			add_location(div3, file$2, 64, 3, 1936);
    			attr_dev(h22, "class", "row__title svelte-1p52rxf");
    			add_location(h22, file$2, 69, 4, 2101);
    			attr_dev(div4, "class", "row svelte-1p52rxf");
    			add_location(div4, file$2, 68, 3, 2079);
    			attr_dev(h23, "class", "row__title svelte-1p52rxf");
    			add_location(h23, file$2, 73, 4, 2238);
    			attr_dev(div5, "class", "row svelte-1p52rxf");
    			add_location(div5, file$2, 72, 3, 2216);
    			attr_dev(h24, "class", "row__title svelte-1p52rxf");
    			add_location(h24, file$2, 77, 4, 2368);
    			attr_dev(div6, "class", "row svelte-1p52rxf");
    			add_location(div6, file$2, 76, 3, 2346);
    			attr_dev(h25, "class", "row__title svelte-1p52rxf");
    			add_location(h25, file$2, 81, 4, 2501);
    			attr_dev(div7, "class", "row svelte-1p52rxf");
    			add_location(div7, file$2, 80, 3, 2479);
    			attr_dev(h26, "class", "row__title svelte-1p52rxf");
    			add_location(h26, file$2, 85, 4, 2650);
    			attr_dev(div8, "class", "row svelte-1p52rxf");
    			add_location(div8, file$2, 84, 3, 2628);
    			attr_dev(h27, "class", "row__title svelte-1p52rxf");
    			add_location(h27, file$2, 89, 4, 2766);
    			add_location(button0, file$2, 90, 4, 2808);
    			attr_dev(div9, "class", "row svelte-1p52rxf");
    			add_location(div9, file$2, 88, 3, 2744);
    			attr_dev(h28, "class", "row__title svelte-1p52rxf");
    			add_location(h28, file$2, 93, 4, 2896);
    			add_location(button1, file$2, 94, 4, 2940);
    			attr_dev(div10, "class", "row svelte-1p52rxf");
    			add_location(div10, file$2, 92, 3, 2874);
    			attr_dev(div11, "class", "dashbord");
    			add_location(div11, file$2, 59, 2, 1770);
    			attr_dev(div12, "class", "wrap svelte-1p52rxf");
    			add_location(div12, file$2, 52, 1, 1392);
    			add_location(main, file$2, 50, 0, 1269);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*animateTxt*/ 2 && span_class_value !== (span_class_value = "overtxt " + (/*animateTxt*/ ctx[1] ? 'fadein' : 'hide') + " svelte-1p52rxf")) {
    			...
    			if (!current || dirty & /*animate*/ 1 && div0_class_value !== (div0_class_value = "inner " + (/*animate*/ ctx[0] ? 'fadein' : 'hide') + " svelte-1p52rxf")) {
    				attr_dev(div0, "class", div0_class_value);
    			}
    ...
    /* src/pages/Issue01.svelte generated by Svelte v3.43.1 */
    const file$1 = "src/pages/Issue01.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	selectmixmode1.$on("value", /*handleChangeSelecteBgImage*/ ctx[13]);
    	filereader = new FileReader_1({ $$inline: true });
    	filereader.$on("value", /*handleChangeBgImage*/ ctx[14]);

    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "mix blend mode issue01";
    			t1 = space();
    			div12 = element("div");
    			div1 = element("div");
    			div0 = element("div");
    			...
    			button1.textContent = "フェードイン";
    			attr_dev(h1, "class", "title");
    			add_location(h1, file$1, 48, 1, 1268);
    			attr_dev(span, "class", span_class_value = "overtxt " + (/*animateTxt*/ ctx[1] ? 'fadein' : 'hide') + " svelte-7emh97");
    			set_style(span, "color", /*txtcolor*/ ctx[5]);
    			set_style(span, "background-color", /*txtbgcolor*/ ctx[4]);
    			set_style(span, "mix-blend-mode", /*mode*/ ctx[2]);
    			add_location(span, file$1, 52, 4, 1434);
    			if (!src_url_equal(img.src, img_src_value = /*bgImg*/ ctx[7])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			set_style(img, "mix-blend-mode", /*modebgimg*/ ctx[3]);
    			attr_dev(img, "class", "svelte-7emh97");
    			add_location(img, file$1, 53, 4, 1593);
    			attr_dev(div0, "class", div0_class_value = "inner " + (/*animate*/ ctx[0] ? 'fadein' : 'hide') + " svelte-7emh97");
    			add_location(div0, file$1, 51, 3, 1380);
    			attr_dev(div1, "class", div1_class_value = "img " + (/*pat*/ ctx[8] ? 'is_pat' : null) + " svelte-7emh97");
    			add_location(div1, file$1, 50, 2, 1336);
    			attr_dev(h20, "class", "row__title svelte-7emh97");
    			add_location(h20, file$1, 58, 4, 1726);
    			attr_dev(div2, "class", "row svelte-7emh97");
    			add_location(div2, file$1, 57, 3, 1704);
    			attr_dev(h21, "class", "row__title svelte-7emh97");
    			add_location(h21, file$1, 62, 4, 1866);
    			attr_dev(div3, "class", "row svelte-7emh97");
    			add_location(div3, file$1, 61, 3, 1844);
    			attr_dev(h22, "class", "row__title svelte-7emh97");
    			add_location(h22, file$1, 66, 4, 2009);
    			attr_dev(div4, "class", "row svelte-7emh97");
    			add_location(div4, file$1, 65, 3, 1987);
    			attr_dev(h23, "class", "row__title svelte-7emh97");
    			add_location(h23, file$1, 70, 4, 2146);
    			attr_dev(div5, "class", "row svelte-7emh97");
    			add_location(div5, file$1, 69, 3, 2124);
    			attr_dev(h24, "class", "row__title svelte-7emh97");
    			add_location(h24, file$1, 74, 4, 2276);
    			attr_dev(div6, "class", "row svelte-7emh97");
    			add_location(div6, file$1, 73, 3, 2254);
    			attr_dev(h25, "class", "row__title svelte-7emh97");
    			add_location(h25, file$1, 78, 4, 2425);
    			attr_dev(div7, "class", "row svelte-7emh97");
    			add_location(div7, file$1, 77, 3, 2403);
    			attr_dev(h26, "class", "row__title svelte-7emh97");
    			add_location(h26, file$1, 82, 4, 2541);
    			attr_dev(input, "name", "pattern");
    			attr_dev(input, "type", "checkbox");
    			add_location(input, file$1, 84, 5, 2607);
    			attr_dev(label, "for", "pattern");
    			add_location(label, file$1, 83, 4, 2580);
    			attr_dev(div8, "class", "row svelte-7emh97");
    			add_location(div8, file$1, 81, 3, 2519);
    			attr_dev(h27, "class", "row__title svelte-7emh97");
    			add_location(h27, file$1, 88, 4, 2723);
    			add_location(button0, file$1, 89, 4, 2765);
    			attr_dev(div9, "class", "row svelte-7emh97");
    			add_location(div9, file$1, 87, 3, 2701);
    			attr_dev(h28, "class", "row__title svelte-7emh97");
    			add_location(h28, file$1, 92, 4, 2853);
    			add_location(button1, file$1, 93, 4, 2897);
    			attr_dev(div10, "class", "row svelte-7emh97");
    			add_location(div10, file$1, 91, 3, 2831);
    			attr_dev(div11, "class", "dashbord");
    			add_location(div11, file$1, 56, 2, 1678);
    			attr_dev(div12, "class", "wrap svelte-7emh97");
    			add_location(div12, file$1, 49, 1, 1315);
    			add_location(main, file$1, 47, 0, 1191);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div6, h24);
    			append_dev(div6, t18);
    			mount_component(selectmixmode1, div6, null);
    			append_dev(div11, t19);
    			append_dev(div11, div7);
    			append_dev(div7, h25);
    			append_dev(div7, t21);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button0, "click", /*handleClickFadeIn*/ ctx[15], false, false, false),
    					listen_dev(button1, "click", /*handleClickFadeInTxt*/ ctx[16], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*animateTxt*/ 2 && span_class_value !== (span_class_value = "overtxt " + (/*animateTxt*/ ctx[1] ? 'fadein' : 'hide') + " svelte-7emh97")) {
    				attr_dev(span, "class", span_class_value);
    			}
    			...
    			if (!current || dirty & /*animate*/ 1 && div0_class_value !== (div0_class_value = "inner " + (/*animate*/ ctx[0] ? 'fadein' : 'hide') + " svelte-7emh97")) {
    				attr_dev(div0, "class", div0_class_value);
    			}

    			if (!current || dirty & /*pat*/ 256 && div1_class_value !== (div1_class_value = "img " + (/*pat*/ ctx[8] ? 'is_pat' : null) + " svelte-7emh97")) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Issue01> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('pat' in $$props) $$invalidate(8, pat = $$props.pat);
    	};
    ...
    class Issue01 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file, 17, 4, 433);
    			attr_dev(a1, "data-current", a1_data_current_value = /*$location*/ ctx[0] === '/bg/' ? 'true' : 'false');
    			attr_dev(a1, "class", "svelte-1p7yv5h");
    			add_location(a1, file, 19, 4, 606);
    			attr_dev(a2, "data-current", a2_data_current_value = /*$location*/ ctx[0] === '/issue01/' ? 'true' : 'false');
    			attr_dev(a2, "class", "svelte-1p7yv5h");
    			add_location(a2, file, 21, 4, 792);
    			attr_dev(div0, "class", "nav svelte-1p7yv5h");
    			add_location(div0, file, 15, 2, 361);
    			attr_dev(div1, "class", "wrap");
    			add_location(div1, file, 14, 0, 340);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					action_destroyer(link.call(null, a2, { href: '/issue01/', disabled: false }))
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*$location*/ 1 && a2_data_current_value !== (a2_data_current_value = /*$location*/ ctx[0] === '/issue01/' ? 'true' : 'false')) {
    				attr_dev(a2, "data-current", a2_data_current_value);
    			}
    		},
    		i: function intro(local) {
    			if (current) return;
